...
function generateReportHtml(input: {
  ...
  const commitShort = run.commitSha.slice(0, 7);
  const appUrl = input.dashboardUrl || process.env.NEXT_PUBLIC_APP_URL || "https://ghostfounder.com";
                      ...
                      <tr>
                        <td align="center">
                          <p style="margin: 0 0 8px 0; color: #52525b; font-size: 12px;">
                            Sent by <a href="https://ghostfounder.com" style="color: #a78bfa; text-decoration: none; font-weight: 500;">GhostFounder</a> Code Police
                          </p>
